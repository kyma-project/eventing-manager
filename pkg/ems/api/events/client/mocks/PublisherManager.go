...
func (_m *PublisherManager) Publish(cloudEvent v2.Event, qos types.Qos) (*types.PublishResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(v2.Event, types.Qos) (*types.PublishResponse, error)); ok {
		return rf(cloudEvent, qos)
	}
	if rf, ok := ret.Get(0).(func(v2.Event, types.Qos) *types.PublishResponse); ok {
	...
	if rf, ok := ret.Get(1).(func(v2.Event, types.Qos) error); ok {
...
func (_c *PublisherManager_Publish_Call) Run(run func(cloudEvent v2.Event, qos types.Qos)) *PublisherManager_Publish_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(v2.Event), args[1].(types.Qos))
	})
	return _c
}
