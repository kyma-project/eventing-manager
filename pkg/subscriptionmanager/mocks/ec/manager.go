...
func (_m *Manager) Start(defaultSubsConfig env.DefaultSubscriptionConfig, params subscriptionmanager.Params) error {
	ret := _m.Called(defaultSubsConfig, params)

	var r0 error
	if rf, ok := ret.Get(0).(func(env.DefaultSubscriptionConfig, subscriptionmanager.Params) error); ok {
...
//   - params subscriptionmanager.Params
...
func (_c *Manager_Start_Call) Run(run func(defaultSubsConfig env.DefaultSubscriptionConfig, params subscriptionmanager.Params)) *Manager_Start_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(env.DefaultSubscriptionConfig), args[1].(subscriptionmanager.Params))
	})
	return _c
}
...
func (_c *Manager_Start_Call) RunAndReturn(run func(env.DefaultSubscriptionConfig, subscriptionmanager.Params) error) *Manager_Start_Call {
	_c.Call.Return(run)
	return _c
}
