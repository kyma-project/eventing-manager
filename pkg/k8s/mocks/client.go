...
// DynamicPatchApply provides a mock function with given fields: _a0, _a1
func (_m *Client) DynamicPatchApply(_a0 context.Context, _a1 *unstructured.Unstructured) error {
...
// Client_DynamicPatchApply_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DynamicPatchApply'
type Client_DynamicPatchApply_Call struct {
	*mock.Call
}

// DynamicPatchApply is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 *unstructured.Unstructured
func (_e *Client_Expecter) DynamicPatchApply(_a0 interface{}, _a1 interface{}) *Client_DynamicPatchApply_Call {
	return &Client_DynamicPatchApply_Call{Call: _e.mock.On("DynamicPatchApply", _a0, _a1)}
}

func (_c *Client_DynamicPatchApply_Call) Run(run func(_a0 context.Context, _a1 *unstructured.Unstructured)) *Client_DynamicPatchApply_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Client_DynamicPatchApply_Call) Return(_a0 error) *Client_DynamicPatchApply_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_DynamicPatchApply_Call) RunAndReturn(run func(context.Context, *unstructured.Unstructured) error) *Client_DynamicPatchApply_Call {
	_c.Call.Return(run)
	return _c
}

// GetAuthorizationPolicy provides a mock function with given fields: _a0, _a1, _a2
func (_m *Client) GetAuthorizationPolicy(_a0 context.Context, _a1 string, _a2 string) (*v1beta1.AuthorizationPolicy, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *v1beta1.AuthorizationPolicy
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*v1beta1.AuthorizationPolicy, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *v1beta1.AuthorizationPolicy); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1beta1.AuthorizationPolicy)
		}
	}
...
// Client_GetAuthorizationPolicy_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAuthorizationPolicy'
type Client_GetAuthorizationPolicy_Call struct {
	*mock.Call
}

// GetAuthorizationPolicy is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 string
//   - _a2 string
func (_e *Client_Expecter) GetAuthorizationPolicy(_a0 interface{}, _a1 interface{}, _a2 interface{}) *Client_GetAuthorizationPolicy_Call {
	return &Client_GetAuthorizationPolicy_Call{Call: _e.mock.On("GetAuthorizationPolicy", _a0, _a1, _a2)}
}

func (_c *Client_GetAuthorizationPolicy_Call) Run(run func(_a0 context.Context, _a1 string, _a2 string)) *Client_GetAuthorizationPolicy_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *Client_GetAuthorizationPolicy_Call) Return(_a0 *v1beta1.AuthorizationPolicy, _a1 error) *Client_GetAuthorizationPolicy_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Client_GetAuthorizationPolicy_Call) RunAndReturn(run func(context.Context, string, string) (*v1beta1.AuthorizationPolicy, error)) *Client_GetAuthorizationPolicy_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetRequestAuthentication provides a mock function with given fields: _a0, _a1, _a2
func (_m *Client) GetRequestAuthentication(_a0 context.Context, _a1 string, _a2 string) (*v1beta1.RequestAuthentication, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *v1beta1.RequestAuthentication
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*v1beta1.RequestAuthentication, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *v1beta1.RequestAuthentication); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1beta1.RequestAuthentication)
		}
	}
...
// Client_GetRequestAuthentication_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetRequestAuthentication'
type Client_GetRequestAuthentication_Call struct {
	*mock.Call
}

// GetRequestAuthentication is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 string
//   - _a2 string
func (_e *Client_Expecter) GetRequestAuthentication(_a0 interface{}, _a1 interface{}, _a2 interface{}) *Client_GetRequestAuthentication_Call {
	return &Client_GetRequestAuthentication_Call{Call: _e.mock.On("GetRequestAuthentication", _a0, _a1, _a2)}
}

func (_c *Client_GetRequestAuthentication_Call) Run(run func(_a0 context.Context, _a1 string, _a2 string)) *Client_GetRequestAuthentication_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *Client_GetRequestAuthentication_Call) Return(_a0 *v1beta1.RequestAuthentication, _a1 error) *Client_GetRequestAuthentication_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Client_GetRequestAuthentication_Call) RunAndReturn(run func(context.Context, string, string) (*v1beta1.RequestAuthentication, error)) *Client_GetRequestAuthentication_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetService provides a mock function with given fields: _a0, _a1, _a2
func (_m *Client) GetService(_a0 context.Context, _a1 string, _a2 string) (*corev1.Service, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
//   - _a1 string
//   - _a2 string
func (_e *Client_Expecter) GetService(_a0 interface{}, _a1 interface{}, _a2 interface{}) *Client_GetService_Call {
	return &Client_GetService_Call{Call: _e.mock.On("GetService", _a0, _a1, _a2)}
}

func (_c *Client_GetService_Call) Run(run func(_a0 context.Context, _a1 string, _a2 string)) *Client_GetService_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *Client_GetService_Call) RunAndReturn(run func(context.Context, string, string) (*corev1.Service, error)) *Client_GetService_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Client) GetVirtualService(_a0 context.Context, _a1 string, _a2 string) (*networkingv1beta1.VirtualService, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *networkingv1beta1.VirtualService
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*networkingv1beta1.VirtualService, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *networkingv1beta1.VirtualService); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*networkingv1beta1.VirtualService)
		}
	}
...
// Client_GetVirtualService_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetVirtualService'
type Client_GetVirtualService_Call struct {
	*mock.Call
}

// GetVirtualService is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 string
//   - _a2 string
func (_e *Client_Expecter) GetVirtualService(_a0 interface{}, _a1 interface{}, _a2 interface{}) *Client_GetVirtualService_Call {
	return &Client_GetVirtualService_Call{Call: _e.mock.On("GetVirtualService", _a0, _a1, _a2)}
}

func (_c *Client_GetVirtualService_Call) Run(run func(_a0 context.Context, _a1 string, _a2 string)) *Client_GetVirtualService_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *Client_GetVirtualService_Call) Return(_a0 *networkingv1beta1.VirtualService, _a1 error) *Client_GetVirtualService_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Client_GetVirtualService_Call) RunAndReturn(run func(context.Context, string, string) (*networkingv1beta1.VirtualService, error)) *Client_GetVirtualService_Call {
	_c.Call.Return(run)
	return _c
}
