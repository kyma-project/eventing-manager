...
// GetHPA provides a mock function with given fields: ctx, name, namespace
func (_m *Client) GetHPA(ctx context.Context, name string, namespace string) (*v2.HorizontalPodAutoscaler, error) {
	ret := _m.Called(ctx, name, namespace)

	var r0 *v2.HorizontalPodAutoscaler
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*v2.HorizontalPodAutoscaler, error)); ok {
		return rf(ctx, name, namespace)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *v2.HorizontalPodAutoscaler); ok {
		r0 = rf(ctx, name, namespace)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v2.HorizontalPodAutoscaler)
		}
	}
...
// Client_GetHPA_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetHPA'
type Client_GetHPA_Call struct {
	*mock.Call
}

// GetHPA is a helper method to define mock.On call
//   - ctx context.Context
//   - name string
//   - namespace string
func (_e *Client_Expecter) GetHPA(ctx interface{}, name interface{}, namespace interface{}) *Client_GetHPA_Call {
	return &Client_GetHPA_Call{Call: _e.mock.On("GetHPA", ctx, name, namespace)}
}

func (_c *Client_GetHPA_Call) Run(run func(ctx context.Context, name string, namespace string)) *Client_GetHPA_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *Client_GetHPA_Call) Return(_a0 *v2.HorizontalPodAutoscaler, _a1 error) *Client_GetHPA_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Client_GetHPA_Call) RunAndReturn(run func(context.Context, string, string) (*v2.HorizontalPodAutoscaler, error)) *Client_GetHPA_Call {
	_c.Call.Return(run)
	return _c
}
