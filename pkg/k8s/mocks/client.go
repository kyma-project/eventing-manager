...
func (_m *Client) UpdateDeployment(_a0 context.Context, _a1 *v1.Deployment) error {
	ret := _m.Called(_a0, _a1)
...
func (_c *Client_UpdateDeployment_Call) Run(run func(_a0 context.Context, _a1 *v1.Deployment)) *Client_UpdateDeployment_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Client_UpdateDeployment_Call) RunAndReturn(run func(context.Context, *v1.Deployment) error) *Client_UpdateDeployment_Call {
	_c.Call.Return(run)
	return _c
}
