...
type Eventing struct {
	...
	// +kubebuilder:validation:XValidation:rule="(self.backend.type == 'EventMesh') && (self.backend.config.eventMeshSecret != ' ')", message="secret cannot be empty if EventMesh backend is used"
