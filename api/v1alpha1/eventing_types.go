...
type Eventing struct {
	...
	// +kubebuilder:default:={backends:{type:"NATS", config:{natsStreamStorageType:"File",natsStreamReplicas:3,natsMaxStreamSize:"700Mi",natsMaxMsgsPerTopic:1000000}}, publisher:{replicas:{min:2,max:2}}, logging:{loglevel:"info"}}
