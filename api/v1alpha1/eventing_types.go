...
type EventingSpec struct {
	...
	// +kubebuilder:validation:XValidation:rule="(self.type == 'NATS') || ((self.type == 'EventMesh') && (self.config.eventMeshSecret != ''))", message="secret cannot be empty if EventMesh backend is used"
