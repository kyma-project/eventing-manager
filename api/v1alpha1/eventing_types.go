...
type Eventing struct {
	...
	// +kubebuilder:validation:XValidation:rule="(self.backends.type == 'EventMesh') && (self.backends.config.eventMeshSecret != ' ')", message="secret cannot be empty if EventMesh backend is used"
